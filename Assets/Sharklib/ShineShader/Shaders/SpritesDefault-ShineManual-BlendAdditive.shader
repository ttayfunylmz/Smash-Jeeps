...
Shader "Sharkbomb/Shine/SpriteDefault-ShineManual-BlendAdditive"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 SpriteFragShine(v2f IN) : SV_Target
			{
				...
				c.rgb += getShinePixelAlpha(_TimeControl, _WaveWidth, _WaveFade, (tex2D(_RampTex, IN.texcoord).r)) * _RampColor;
				c.rgb *= c.a;
				return c;
			}
