...
Shader "Sharkbomb/Shine/UI-ShineManual-BlendAdditive"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				color.rgb += getShinePixelAlpha(_TimeControl, _WaveWidth, _WaveFade, (tex2D(_RampTex, IN.texcoord).rb)) * _RampColor;
