...
Shader "Sharkbomb/Shine/SpriteDiffuse-Shine-Emission"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vert(inout appdata_full v, out Input o)
		{
			...
			// Save the time
			o.time = getShineTime(_WaveFreq, _WavePause, _Time.y, _WaveWidth, _WaveFade);
		}
		...
		void SpriteSurfShine(Input IN, inout SurfaceOutput o)
		{
			...
			o.Emission = _RampColor * getShinePixelAlpha(IN.time, _WaveWidth, _WaveFade, (tex2D(_RampTex, IN.uv_MainTex).rb)) * c.a;
		}
		ENDCG
	}
